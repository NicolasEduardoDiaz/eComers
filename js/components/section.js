    ...
    `<article class="article_detail">
        <div class="detail_head">
            ...
            <div class="product__select">
                ...
                <img id="btn_plus" src="../storage/img/plus.svg">
            </div>
        </div>
        <div class="detail_score">
            ...
            <a href="${dataUpdate.product_url}">(${dataUpdate.product_num_rating} review)</a>
        </div>
    </article>`;
}
...
export const productDetail = async(res) => {
    ...
    return /*html*/
    `<details>
        <summary>${(dataUpdate.product_description.lengt >= 165) ? string1+"..." : string1}</summary>
        <p>${string2}</p>
    </details>`;
}